...
4. Berechtigungsannahme prüfen: derzeit sehen alle aktiven Konten alle Dokumente und reviewer/admin dürfen selbst erstellte Dokumente freigeben. Falls der Kunde Abteilungsgrenzen oder Vier-Augen-Prüfung braucht, zentrale Policies und entsprechende negative Tests erweitern.
...
6. Bei Live-KI Anbieterfreigabe, Modellzugriff, Kostenlimit, Dokumentumfang und Qualität mit synthetischen sowie freigegebenen repräsentativen Beispielen prüfen. Ergebnisse bleiben menschlich freizugeben.
...
Bis ungefähr 400 Konten ist keine Aussage über gleichzeitige Verarbeitung. Workerzahl, PHP-FPM-Pool, Uploadlimit und Providerlimits anhand realer Lastmessung einstellen. Zunächst ein Worker; weitere Worker verwenden dasselbe Image und dieselbe Datenbank-Queue. Die vorhandenen Lauf-Leases schützen auch bei mehreren Workern.
