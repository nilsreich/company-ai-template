Read AGENTS.md for project architecture, security rules and verified commands. Laravel Boost is available as a development-only MCP server. Framework skills are in .agents/skills.
